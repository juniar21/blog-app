  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg shadow w-full">
      ...
      <div className="p-4">
        ...
        <Link
          href={`/blog/${objectId}`}
          className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-amber-400 rounded-lg hover:bg-amber-600 focus:ring-4 focus:outline-none focus:ring-teal-300 dark:bg-teal-600 dark:hover:bg-teal-700 dark:focus:ring-teal-800"
        >
          Read more
        </Link>
      </div>
